...
const DB_PRIVATE_KEY = "h4ckrth0n_device_private_key";
const DB_PUBLIC_JWK = "h4ckrth0n_device_public_jwk";
const DB_DEVICE_ID = "h4ckrth0n_device_id";
const DB_USER_ID = "h4ckrth0n_user_id";
