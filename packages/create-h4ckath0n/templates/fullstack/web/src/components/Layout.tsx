...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:px-4 focus:py-2 focus:bg-primary focus:text-white focus:rounded-b-lg focus:top-0 focus:left-4"
      >
