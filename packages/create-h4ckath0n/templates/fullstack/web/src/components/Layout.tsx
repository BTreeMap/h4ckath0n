...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:p-4 focus:bg-surface focus:text-text focus:font-medium focus:border-b focus:border-border"
      >
