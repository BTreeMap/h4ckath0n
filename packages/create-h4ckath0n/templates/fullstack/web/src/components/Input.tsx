        ...
        <div className="relative">
          ...
          {isPassword && (
            <button
              ...
              className="absolute right-0 top-0 flex h-10 w-10 items-center justify-center text-text-muted hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-xl"
