...
| `H4CKATH0N_OPENAI_API_KEY` | `` | Alternate OpenAI API key for the LLM wrapper |
| `H4CKATH0N_REDIS_URL` | `` | Redis connection URL |
...
| `H4CKATH0N_SMTP_HOST` | `` | SMTP server hostname |
| `H4CKATH0N_SMTP_PORT` | `587` | SMTP server port |
| `H4CKATH0N_SMTP_USERNAME` | `` | SMTP authentication username |
| `H4CKATH0N_SMTP_PASSWORD` | `` | SMTP authentication password |
