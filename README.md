...
| `H4CKATH0N_STORAGE_BACKEND` | `local` | File storage backend (`local` or other supported) |
...
| `H4CKATH0N_APP_BASE_URL` | `http://localhost:5173` | Base URL of the frontend web application |
