...
class Settings(BaseSettings):
    ...
    # --- Email ---
    app_base_url: str = Field("http://localhost:5173", description="Base URL for email links")
    email_backend: str = Field("file", description="Email backend type (`file` or `smtp`)")
    email_from: str = Field("noreply@localhost", description="Sender email address")
