...
# 🛡️ Sentinel: Dummy hash for mitigating timing attacks during authentication.
_DUMMY_PASSWORD_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$ubc/51xV8cBQoR7lVfBDiA$"
    "UJiq8xuxieW0/+AxFN3FPCgSH8n9uDQq1xvZmeH/4Ps"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # 🛡️ Sentinel: Mitigate timing attacks by always performing a hash verification.
    # If the user doesn't exist or has no password, verify against a dummy hash.
