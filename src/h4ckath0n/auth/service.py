...
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$wrw6dyg7Mjj8KfnlcZirpQ"
    "$EZao+1S/8Gig4uzF022KpsYXVWIP7QC+pJbHUZGSRMI"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # Timing attack mitigation: always verify a password hash.
    # If the user doesn't exist or doesn't have a password, we verify against a dummy hash.
