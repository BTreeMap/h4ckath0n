...
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$8x8sfA3fQfBOckrNopCx1g"
    "$HV3qedfi3hPaHjduWLtUBcgqW1J756QFEnYoZwzUmLw"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # Mitigate user enumeration timing attacks by always hashing something
