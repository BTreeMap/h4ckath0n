...
# Dummy hash for timing attack mitigation. Must be a structurally valid Argon2id string.
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$7PnKUoZ7sTGZa7WXwKghrg"
    "$nQm76Uz6arDiSNTfVkyXNdvhtjp2eU8isNXWejqh+MI"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # 🛡️ Sentinel: Always verify against a hash (real or dummy) to mitigate timing attacks
