...
# Dummy valid Argon2 hash for mitigating user enumeration timing attacks
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$icidI/T8U7q37gfaGQ/WWg"
    "$Js7JepSe0WgdypNm9mhhUe+GTEUrUD/2VtoTSDZ3ZmA"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    if user is None or not user.password_hash:
        # Prevent timing attacks by hashing against a dummy hash
