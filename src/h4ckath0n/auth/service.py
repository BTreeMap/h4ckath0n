...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # 🛡️ Sentinel: Mitigate timing attacks by always verifying a dummy hash if user is not found
    dummy_hash = (
        "$argon2id$v=19$m=65536,t=3,p=4$hxvbHQ2he7/XUf94RMeUBQ"
        "$EnJOLe4OuLahiabrK2/kPToB0BNq5dhAxc4SXKx3Lsk"
    )
