...
# A valid argon2id hash of "dummy_password" to mitigate timing attacks
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$+CZhdLegMqimtPTNXCf+xQ"
    "$UtME4NhfNfrbp5N98IkFT9KPNXivV7TLAnPjA06tcFk"
)
