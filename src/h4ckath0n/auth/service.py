...
DUMMY_PASSWORD_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$Tk8DGFWHpaDMTb4g9h2wlA"
    "$+IBBfjcQxYWOJYw+VdvjYCAGFE9Ci6d9t2Uoz7PF1pk"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # 🛡️ Sentinel: Mitigate timing attacks by verifying against a dummy hash if user is not found
    ...
    if not is_valid or not user or not user.password_hash:
        return None
    return user
