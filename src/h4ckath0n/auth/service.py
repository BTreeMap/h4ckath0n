...
async def register_user(
    ...
    *,
    ...
    # Bolt: Use db.scalar() querying just the ID to avoid instantiating the full User model
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # Bolt: Use db.scalar() directly to avoid unnecessary intermediate ExecutionResult allocation
