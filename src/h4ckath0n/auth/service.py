...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # A valid dummy Argon2id hash to mitigate timing attacks during user enumeration.
    dummy_hash = (
        "$argon2id$v=19$m=65536,t=3,p=4$a3Z21vhnoMXlH0HKxv6Umg$"
        "MKbtpV3UpXkx7Op2yFL9/2rylZdKxkpTZ2AYFf//Ncw"
    )
