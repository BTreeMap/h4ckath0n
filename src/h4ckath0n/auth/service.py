...
# A structurally valid dummy Argon2id hash to mitigate timing attacks.
# Matches the default parameters of argon2-cffi.
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$TQtul6+DLdRQEf+fkoRzMg$"
    "tHED3K1AYFcbMSIhi++6ONHJ/gmYmgCl6lOeaIImhF0"
)
