...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # 🛡️ Sentinel: Mitigate timing attacks by verifying a valid dummy hash
    # when the user is not found or has no password hash.
    # The dummy hash MUST be a structurally valid Argon2id hash.
    dummy_hash = (
        "$argon2id$v=19$m=65536,t=3,p=4$V2z8R/mUb3pC3VwrAY52nw"
        "$9LdfnXnG2wJ7CDk98q7pVoVR3GVPUZg4YnlOj2p5wpg"
    )
