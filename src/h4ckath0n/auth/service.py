...
# Structurally valid Argon2id hash to mitigate timing attacks on invalid users.
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$ZrqNd9RrdEHJIkQGoqDrug$"
    "TJYnx903AUgU1HnRSUk07aFlyF/ZC1RFyMecoJZxwto"
)
