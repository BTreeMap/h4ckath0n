...
# A valid Argon2id hash for mitigation of user enumeration timing attacks.
_DUMMY_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$rgjeA7ezrkgD72TjFOICYw$"
    "td7Ord0jB5Ep0sUrcEWqSrLEUcRkF0ezNbFjpuetYwQ"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    if user is None or not user.password_hash:
        # Mitigate timing attack by hashing against a dummy hash
