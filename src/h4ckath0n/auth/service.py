...
# A pre-computed dummy argon2id hash to prevent user enumeration timing attacks.
DUMMY_PASSWORD_HASH = (
    "$argon2id$v=19$m=65536,t=3,p=4$x2AgAVMqNExzJIthPRgOgw"
    "$wOJ6S78cu/kgkddEG4UKrKYFeLmm/Cx51Dn2IJ28vLY"
)
...
async def authenticate_user(db: AsyncSession, email: str, password: str) -> User | None:
    ...
    # 🛡️ Sentinel: Always verify a hash to prevent user enumeration timing attacks
