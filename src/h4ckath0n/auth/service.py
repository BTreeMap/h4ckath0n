...
async def register_user(
    ...
    *,
    ...
    # ⚡ Bolt: Avoid intermediate Result object hydration overhead
    result = await db.scalar(select(User).filter(User.email == email))
    if result:
