...
from h4ckrth0n.llm.types import ChatResponse
    ...
    def __init__(
        ...
        *,
        ...
        resolved_key = (
            ...
            or os.environ.get("H4CKRTH0N_OPENAI_API_KEY", "")
        )
        if not resolved_key:
            raise RuntimeError(
                "No OpenAI API key configured. Set OPENAI_API_KEY or H4CKRTH0N_OPENAI_API_KEY."
            )
        self._client = OpenAI(
